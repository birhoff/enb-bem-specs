var path = require('path'),
    ...
    browserify = require('enb-browserify'),
...
exports.configure = function(config, options) {
    ...
    config.nodes(pattern, function(nodeConfig) {
        ...
        nodeConfig.addTechs([
            ...
            [mergeFiles, {
                target: '?.browser.spec.js',
                sources: ['?.pure.ym.js', '?.browserify.browser.js', '?.browser.template.js', '?.pure.spec.js']
